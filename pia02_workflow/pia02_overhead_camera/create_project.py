...
if __name__ == "__main__":
    ...
    video_root_path = r"\\192.168.1.104\home\piano\data\overhead_camera\dlc_projects\overhead_camera"

    project_name = 'keyboard_segmentation'
    annotator_name = 'x'
    ...
    working_directory = r"\\192.168.1.104\home\piano\data\overhead_camera\dlc_projects\overhead_camera"
    ...
    config_dict = {'bodyparts': ['point0', 'point1', 'point2', 'point3'], 'skeleton': None}
